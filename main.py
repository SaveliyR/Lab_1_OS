...
aa = input('Выберите задание, введя цифру:\n'
          '1. Работа с файлами\n'
...
match aa:
    case '1':
        ...
        def filework():
            ...
            print(my_file.read())
            my_file.close()
            r = int(input("Хотите удалить созданный файл(0/1): "))
            if  r==1:
                os.remove(name)
        filework()
    case '2':
    ...
    case '4':
        ...
        archive.extractall()
        archive.close()
        r = int(input("Хотите удалить созданный файл и архив(0/1): "))
        if r == 1:
            os.remove(zipfilename)
            os.remove("Data.zip")